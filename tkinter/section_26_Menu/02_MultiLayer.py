...
root = tk.Tk()
root.title('Adding Multi-layer Menu')
...
menubar_2.add_command(label='BBB')              # 子選單第二個選項
menubar_2.add_command(label='CCC')              # 子選單第三個選項
menubar_2.add_separator()                       # 子選單分隔線

menubar_2_more = tk.Menu(menubar_2)             # 建立第二個選單的子選單的子選單
menubar_2_more.add_command(label='X')           # 子選單的子選單第一個選項
menubar_2_more.add_command(label='Y')           # 子選單的子選單第二個選項
menubar_2_more.add_command(label='Z')           # 子選單的子選單第三個選項
# 建立第一個選單 File，綁定子選單的子選單
menubar_2.add_cascade(label='File', menu=menubar_2_more)
menu.add_cascade(label='Test', menu=menubar_2)  # 建立第二個選單 Test，綁定子選單
